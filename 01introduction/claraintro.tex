...
Manual of Style (18ᵉ édition),\footnote{\citeproc{ref-ChicagoManualStyle}{{``The
  {Chicago Manual} of {Style}, 18th {Edition}.''} }} qui propose un état
des lieux très complet des étapes du processus de publication et
d'édition, et des différentes règles orthotypo à respecter. Prenant
chacune des catégories du sommaire, nous avons tenté de les factoriser
pour avoir un nombre plus limité de types.
...
manuscripts.\footnote{\citeproc{ref-TEIGuidelinesSimple}{{``{The TEI
  Guidelines - Simple Editorial Changes}.''} }}
\end{quote}
...
{``{The TEI Guidelines - Simple Editorial Changes}.''}
