...
- [introduction explicative]() du travail final
- les trois éditions finale : dans le dossier [00editionFinale](00editionFinale)
- consulter le prototype XForm : à [ce lien]() 

## Pour appliquer le reviewer à d'autres documents 

1. Modifier la ligne suivante et remplacer vers un chemin relatif vers les XML du dossier 00editionFinale
...
`pandoc intro.md   --bibliography=biblio-travail-final.bib   --csl=collection-de-l-ecole-francaise-de-rome-full-note.csl   --citeproc   --metadata link-citations=true   --standalone   -o claraintro.tex   -V colorlinks=true   -V linkcolor=blue   -V citecolor=blue   -V urlcolor=blue`
